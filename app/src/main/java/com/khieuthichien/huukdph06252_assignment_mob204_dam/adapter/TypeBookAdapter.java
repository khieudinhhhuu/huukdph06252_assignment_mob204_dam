...
import com.khieuthichien.huukdph06252_assignment_mob204_dam.dao.TypeBookDAO;
...
public class TypeBookAdapter extends RecyclerView.Adapter<TypeBookAdapter.TheloaiHolder> {
    ...
    @NonNull
    @Override
    public TypeBookAdapter.TheloaiHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_theloai, parent, false);
        return new TheloaiHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TypeBookAdapter.TheloaiHolder holder, final int position) {
